...
execute at @s if predicate bts:durability0 run playsound minecraft:entity.item.break
execute if predicate bts:durability0 run item modify entity @s weapon.mainhand bts:delete_item
