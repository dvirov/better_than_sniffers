...
execute if predicate bts:parkour/wall_run rotated ~ 0 unless block ^-1 ^ ^ #bts:transparent if block ~ ~-1 ~ #bts:transparent run function bts:parkour/wall_run
execute if predicate bts:parkour/wall_run rotated ~ 0 unless block ^1 ^ ^ #bts:transparent if block ~ ~-1 ~ #bts:transparent run function bts:parkour/wall_run
execute if predicate bts:parkour/wall_run rotated ~ 0 unless block ^ ^ ^1 #bts:transparent if block ~ ~-1 ~ #bts:transparent run function bts:parkour/wall_run
...
# wall edge climb
execute anchored eyes if block ~ ~-.5 ~ #bts:transparent if block ^ ^ ^1 #bts:transparent unless block ^ ^-1 ^1 #bts:transparent run function bts:parkour/wall_climb
