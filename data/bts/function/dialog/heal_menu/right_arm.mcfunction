...
execute if score @s R.arm matches ..1 run data modify storage temp parts_health.rightarm_trigger set value '"click_event":{"action":"run_command","command":"trigger heal.dialog set 4"},"hover_event":{"action":"show_text","value":{"translate":"dialog.healing.heal_right_arm",fallback:"Heal Right Arm"}}'
