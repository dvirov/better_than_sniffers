...
item replace block ~ ~ ~ container.2 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.3 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.4 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.5 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.6 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
...
item replace block ~ ~ ~ container.20 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.21 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.22 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.23 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.24 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
item replace block ~ ~ ~ container.25 with barrier[item_model="air",max_stack_size=1,tooltip_display={hide_tooltip:true},custom_data={crucible:1b}] 1
