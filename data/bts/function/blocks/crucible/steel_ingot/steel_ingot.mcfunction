...
execute unless items block ~ ~ ~ container.16 music_disc_11 run item replace block ~ ~ ~ container.16 with minecraft:music_disc_11[!minecraft:jukebox_playable,minecraft:max_stack_size=64,minecraft:item_name='{"color":"gray","text":"Steel Ingot"}',minecraft:custom_data={"tag":"steel_ingot"}] 1
