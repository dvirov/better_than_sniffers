...
summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,ShowArms:1b,Small:1b,Invisible:1b,NoBasePlate:1b,Tags:["campfire","placed"],attributes:[{id:"minecraft:generic.scale",base:0.7}],Pose:{LeftArm:[0f,0f,-215f],RightArm:[0f,0f,215f],LeftLeg:[0f,0f,180f],RightLeg:[0f,0f,180f]},DisabledSlots:4079166,CustomName:'" "'}
