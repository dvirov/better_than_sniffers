...
execute if items block ~ ~ ~ container.2 flint \
    if items block ~ ~ ~ container.11 stick \
    if items block ~ ~ ~ container.20 feather \
    unless items block ~ ~ ~ container.16 arrow[minecraft:custom_data={arrow:1b},count=64] \
    unless items block ~ ~ ~ container.16 *[!minecraft:custom_data~{"arrow":1b}] \
    run function bts:blocks/fletching/arrow/arrow


#execute if items block ~ ~ ~ container.2 flint \
    if items block ~ ~ ~ container.11 stick \
    if items block ~ ~ ~ container.20 feather \
    if items block ~ ~ ~ container.16 arrow[minecraft:custom_data={arrow:1b}] \
    unless items block ~ ~ ~ container.16 arrow[minecraft:custom_data={arrow:1b},count=64] \
    run function bts:blocks/fletching/arrow/arrow
