...
execute as @n[distance=..1,type=armor_stand,tag=campfire] at @s if predicate bts:misc/campfire_off run function bts:campfire/unlit


execute as @n[type=armor_stand,tag=campfire,tag=litme] at @s run function bts:campfire/fuel
