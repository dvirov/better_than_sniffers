...
execute if score @s time_in_dark matches 600 if predicate datapack:word_event/rng0.2 run return run tellraw @s {"color":"red","text":"Screams echo around you"}
execute if score @s time_in_dark matches 600 if predicate datapack:word_event/rng0.2 run return run tellraw @s {"color":"red","text":"A horrible chill runs down your spine"}
execute if score @s time_in_dark matches 600 if predicate datapack:word_event/rng0.2 run return run tellraw @s {"color":"red","text":"Your mind goes numb"}
