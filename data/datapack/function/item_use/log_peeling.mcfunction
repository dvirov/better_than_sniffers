...
execute unless score @s raycast matches 50 if block ~ ~ ~ #datapack:transparent positioned ^ ^ ^.1 run function datapack:item_use/log_peeling
scoreboard players reset @s raycast
advancement revoke @s only datapack:trigger/log_peeling