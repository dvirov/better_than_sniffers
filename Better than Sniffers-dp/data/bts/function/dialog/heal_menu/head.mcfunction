...
execute if score @s Head matches ..3 run data modify storage temp parts_health.head_trigger set value '"click_event":{"action":"run_command","command":"trigger heal.dialog set 1"},"hover_event":{"action":"show_text","value":{"translate":"dialog.healing.heal_head",fallback:"Heal Head"}}'
