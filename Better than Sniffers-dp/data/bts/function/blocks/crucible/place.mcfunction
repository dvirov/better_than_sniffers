...
setblock ~ ~ ~ barrel[facing=down]{CustomName:{translate:"block.gui.crucible_name",fallback:"Crucible",extra:[{color:white,translate:"block.gui.crucible_gui",fallback:"      \uF801\uF80B\uF808\uD000"}]}}
