...
execute if block ~ ~ ~ decorated_pot align xyz positioned ~.5 ~.5 ~.5 unless entity @n[distance=..0.00001,tag=pot_display,type=item_display] summon item_display run function bts:item_use/pot_show_items
